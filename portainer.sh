...
docker run -d -p 8000:8000 -p 8090:9000 --name=portainer --restart=always -v /var/run/docker.sock:/var/run/docker.sock -v /media/pi/pi-ssd/container-program-files/portainer_data:/data portainer/portainer-ce
